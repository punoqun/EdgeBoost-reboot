...
class GradientBoostingMachine(BaseEstimator, ABC):
    ...
    def fit(self, X, y):
        ...
        for iteration in range(self.max_iter):
            ...
            for k, (gradients_at_k, hessians_at_k, full_gradients, full_hessians) in enumerate(zip(
                ...
                grower = TreeGrower(
                    X_binned_train, gradients_at_k, hessians_at_k, full_gradients, full_hessians,
